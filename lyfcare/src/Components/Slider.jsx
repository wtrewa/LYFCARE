      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="slider-text">
              Discover Barcelona-born, advanced skin care formulas with
              innovative textures for a practical & sensory experience.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="slider-text-w">
              Our curated roundup of 50 merry- making &I glow giving skin,hair &
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="slider-text-w">
              Save even MORE when you shop up what's on sale-but hurry before
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="slider-text">
              Rewards Memberes. order by December 21st for free two-day
            </p>
            <p className="slider-text">
              shipping & get everything under the tree on time when you spend
              $150 or more
            </p>
            <h2>CODE: Extra94</h2>
            <button>
