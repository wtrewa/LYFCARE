...
export default function CaptionCarousel() {
  ...
  const cards = [
    {
      title: "Fresh Skin for Spring",
      text: "Spring for next-level skin care with formulas & tools that give in-office level vibes without leaving your bathroom.",
      image:
        "https://static.thcdn.com/images/xlarge/webp/widgets/208-us/54/original-Spring_Beauty_1920x700-042754.png",
    },
    {
